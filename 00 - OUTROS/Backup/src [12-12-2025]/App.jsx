...
import Painel from './pages/Painel.jsx'; // <- NOVA PAGE

// ✅ MENU LATERAL COM DOIS MENUS EXPANSÍVEIS
const MenuLateral = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-blue-600 to-blue-800 text-white shadow-2xl z-40 flex flex-col overflow-hidden">
      <div className="p-6 border-b border-blue-500 h-20 flex-shrink-0 flex items-center">
        <div>
          <h1 className="text-xl font-bold mb-1">Sistema G&amp;S</h1>
      ...
      <div className="flex-1 min-h-0 overflow-hidden p-4 pt-2">
        <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-blue-800 pr-2 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-3 rounded-xl bg-blue-700 hover:bg-blue-600 transition-all text-sm font-semibold mt-2"
          >
          ...
          {openRdoMenu && (
            <div className="ml-4 mt-1 space-y-1">
              <NavLink
                to="/rdos"
                className={({ isActive }) =>
                  `flex items-center space-x-3 p-2 rounded-lg w-full text-sm transition-all ${
                    isActive
                      ? 'bg-blue-400 text-white shadow-md'
                      : 'hover:bg-blue-500 text-blue-100'
                  }`
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-3 rounded-xl bg-blue-700 hover:bg-blue-600 transition-all text-sm font-semibold mt-3"
          >
            <span className="flex items-center space-x-2">
              <Settings size={18} />
          ...
          {usuario?.admin && (
            <>
              <div className="mt-4 pt-4 border-t border-blue-500/60">
                <span className="text-xs font-semibold tracking-[0.2em] uppercase text-blue-200">
                  Administração
                </span>
              </div>
        ...
        <div className="text-center mb-3 p-2">
          {usuario?.fotoPerfil ? (
            <img
              ...
              alt={usuario?.nome}
              className="w-12 h-12 mx-auto rounded-full object-cover ring-2 ring-blue-300 mb-2"
            />
          ) : (
...
const LayoutPrincipal = ({ children }) => (
  <div className="flex">
    <MenuLateral />
    <div className="ml-64 flex-1 p-8 bg-gray-50 min-h-screen">{children}</div>
  </div>
);
